...
impl Game {
    ...
    fn roll(&mut self, pins: u16) {
        ...
        // let temp = self.rolls.get(18).unwrap_or(&0) + self.rolls.get(19).unwrap_or(&0);
        // if temp != 10 && self.rolls.len() == 20 {
        //     panic!("You cannot play too much!");
        // }
...
//     #[test]
//     fn test_insert_21_rolls_without_panic() {
//         let mut game = Game { rolls: Vec::new() };
//         for _ in 1..=19 {
//             game.roll(1);
//         }
